            ...
            <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2">
                    <TabsSection
                        ...
                        specification="
              <ul>
                <li><strong>Material:</strong> High-quality plastic and metal components</li>
                <li><strong>Dimensions:</strong> 8.2 x 3.0 x 2.4 inches</li>
                <li><strong>Weight:</strong> 0.5 lbs</li>
                <li><strong>Color:</strong> Black Matte</li>
                ...
                <li><strong>Warranty:</strong> 2 years limited</li>
              </ul>
            "
                        rating={4.5}
                        reviews={[
